...
<div class="message-container">
  <div class="messages-content">
    ...
    <p class="message"><b>Lookup Pali on any sites</b> with Chrome/Opera/Edge <a href='https://chromewebstore.google.com/detail/dhammagift-search-and-wor/dnnogjdcmhbiobpnkhdbfnfjnjlikabd?authuser=1&hl=en'>extention</a>. Or in Android: <a href='#' title='Chrome Android menu → "Add to Home screen"' id='installLink'>Install</a>. Then: select the word → in OS "share" menu choose Dict.DG.</p>
  </div>
...
<p class="message"><b>Словарь на любом сайте: <a href='https://chromewebstore.google.com/detail/dhammagift-search-and-wor/dnnogjdcmhbiobpnkhdbfnfjnjlikabd?authuser=1&hl=ru'>расширение</a> Chrome/Opera/Edge. Или в Android</b>: <a title='или Меню Chrome Android → "Добавить на главную"' href='#' id='installLink'>Install</a>. 
